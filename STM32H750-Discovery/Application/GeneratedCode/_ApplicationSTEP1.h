...
#ifndef _ApplicationSTEP1_H
#define _ApplicationSTEP1_H
...
/* Forward declaration of the class Application::STEP1 */
#ifndef _ApplicationSTEP1_
  EW_DECLARE_CLASS( ApplicationSTEP1 )
#define _ApplicationSTEP1_
#endif
...
/* Deklaration of class : 'Application::STEP1' */
EW_DEFINE_FIELDS( ApplicationSTEP1, ApplicationPanel )
  EW_OBJECT  ( Background,      ViewsRectangle )
  EW_OBJECT  ( ListBtn,         WidgetSetPushButton )
  EW_OBJECT  ( SelectBtn,       WidgetSetPushButton )
  EW_OBJECT  ( Text,            ViewsText )
  EW_OBJECT  ( VerticalList,    CoreVerticalList )
  EW_OBJECT  ( Border,          ViewsBorder )
EW_END_OF_FIELDS( ApplicationSTEP1 )

/* Virtual Method Table (VMT) for the class : 'Application::STEP1' */
EW_DEFINE_METHODS( ApplicationSTEP1, ApplicationPanel )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSTEP1 )
